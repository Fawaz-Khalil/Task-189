...
namespace Task_189
{
    public class OrderModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,name,Discription,Quantity,price")] OrderModel orderModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,name,Discription,Quantity,price")] OrderModel orderModel)
        {
            if (id != orderModel.Id)
            {
                return NotFound();
